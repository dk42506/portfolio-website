document.addEventListener("DOMContentLoaded", function() {
    ...
    document.addEventListener('mousemove', function(event) {
        ...
        chars.forEach(char => {
            ...
            char.style.textShadow = `0 0 ${glowIntensity * 50}px rgba(255, 255, 255, ${glowIntensity})`;
        });
    });
    ...
    function animate() {
        ...
        mouseCircle.style.transform = `translate(${circleX - 10}px, ${circleY - 10}px)`; // Adjust the offset here
